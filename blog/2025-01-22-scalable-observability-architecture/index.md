...
2. [Single-Node Setup](/blog/single-node-observability-setup) — Practical deployment guide
...
The [single-node setup](/blog/single-node-observability-setup) handles most workloads, but you need more when:
